...
export class ProductService {
  ...
  private apiUrl = 'https://homewalletapi.azurewebsites.net/api/api/products/';  // URL to web api
  private apiCategoriesUrl = 'https://homewalletapi.azurewebsites.net/api/api/products/categories/';  // URL to web api
